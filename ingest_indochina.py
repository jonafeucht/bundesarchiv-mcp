...
# Updated defaults for Indochina
DATA_DIR = Path(os.getenv("PDF_DIR", "./indochina")).resolve()
OUTPUT_DIR = Path(os.getenv("DB_URI", "./mcp-server/lancedb_index_indochina")).resolve()
